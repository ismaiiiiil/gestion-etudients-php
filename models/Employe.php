...
class Employe {
    ...
    static public function getEmploye($data){
        ...
        try{
            ...
            $employe = $stmt->fetch(PDO::FETCH_OBJ); // objet
            return $employe;
    ...
    static public function add($data){
        $stmt = DB::connect()->prepare('INSERT INTO employes (nom,prenom,matricule,depart,poste,date_emb,statut)
                                        VALUE (:nom,:prenom,:matricule,:depart,:poste,:date_emb,:statut)');
        ...
        if($stmt->execute()){ // tanchof wach tzad 
            return 'ok';
        }else {
            return 'error';
        }
    ...
    static public function update($data){
        $stmt = DB::connect()->prepare('UPDATE employes 
                            SET nom=:nom,prenom=:prenom,matricule=:matricule,depart=:depart,poste=:poste,date_emb=:date_emb,statut=:statut
                            WHERE id=:id');
